...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 // XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,   XXXXXXX,            XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,
    ...
    KC_LSFT,  KC_Z,     KC_X,     KC_C,     KC_V,      KC_B,               KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  SC_SENT,
                                            KC_LCMD,   LOWER,    SFT_SPC,  RAISE,    KC_LOPT
  ),
 ...
 // XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,   XXXXXXX,            XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,
    ...
    _______,  KC_LCBR,  KC_RCBR,  KC_LBRC,  KC_RBRC,   KC_PLUS,            M_HOME,   KC_PGDN,  KC_PGUP,  M_END,    XXXXXXX,  _______,
                                            _______,   _______,  THINGS,   _______,  _______
  ),

  [_RAISE] = LAYOUT(
 // XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,   XXXXXXX,            XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,
    KC_GRV,   KC_1,     KC_2,     KC_3,     KC_4,      KC_5,               KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_DEL,
    _______,  KC_LCBR,  KC_RCBR,  KC_UNDS,  KC_PLUS,   KC_PIPE,            KC_MINS,  KC_LSFT,  KC_LCMD,  KC_LOPT,  KC_LSFT,  KC_ESC,
    _______,  KC_LBRC,  KC_RBRC,  KC_MINS,  KC_EQL,    KC_BSLS,            KC_EQL,   KC_MNXT,  KC_VOLD,  KC_VOLU,  KC_MPLY,  _______,
                                            _______,   _______,  EMOJI,    _______,  _______
  ),
