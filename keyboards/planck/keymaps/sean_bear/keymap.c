...
[_QWERTY] = LAYOUT_planck_grid(
    ALL_T(KC_GRV), KC_Q, KC_W, KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_MINS,
...
[_LOWER] = LAYOUT_planck_grid(
    _______, KC_WH_D, KC_MS_U, KC_WH_U, _______, _______, KC_BTN3, KC_BTN1, KC_BTN2, KC_MINS, KC_EQL,  KC_BSPC,
    _______, KC_MS_L, KC_MS_D, KC_MS_R, KC_UP,   _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, KC_DEL,
    _______, _______, _______, KC_LEFT, KC_DOWN, KC_RGHT, KC_HOME, KC_PGDN, KC_PGUP, KC_END,  _______, _______,
