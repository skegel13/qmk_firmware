...
[_LOWER] = LAYOUT_planck_grid(
    _______, KC_WH_D, KC_MS_U, KC_WH_U, _______, _______, _______, _______, _______, KC_MINS, KC_EQL,  KC_DEL,
    _______, KC_MS_L, KC_MS_D, KC_MS_R, KC_UP,   _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______,
