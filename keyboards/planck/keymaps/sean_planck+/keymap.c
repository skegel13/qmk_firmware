...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    ALL_T(KC_ESC), KC_LCTL, KC_LALT, KC_LGUI, LOWER, NAV, NAV,     RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
[_NAV] = LAYOUT_planck_grid(
    LSG(KC_LBRC), LGUI(KC_LBRC), KC_UP, _______, _______, _______, _______, _______, _______, _______, LGUI(KC_RBRC), LSG(KC_RBRC),
