...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
    ...
    KC_LCTL,  KC_LGUI, KC_LBRC, KC_RBRC, LOWER,   GUI_TAB, RAYCAST,  EMOJI,    SFT_BSP, RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
  ),
  ...
  [_LOWER] = LAYOUT(
    ...
    _______,  _______, _______, _______, _______, _______, _______,  TERM,     SFT_DEL, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY
  ),
  ...
  [_RAISE] = LAYOUT(
    ...
    _______,  _______, KC_LCBR, KC_RCBR, _______, _______, THINGSC,  _______,  _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY
  ),
